...
---
![zomato_project](https://github.com/saif146/Zomato-Sales-Analysis-SQL-Project/blob/main/poster.png)
## 📌 Project Overview
...
## 🗂️ Database Schema
![DataBase Schema](https://github.com/saif146/Zomato-Sales-Analysis-SQL-Project/blob/main/erd_image.png)
| Table | Description |
|---|---|
